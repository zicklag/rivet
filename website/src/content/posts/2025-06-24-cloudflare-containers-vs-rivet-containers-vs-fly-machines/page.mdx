...
category: technical
keywords: ["cloudflare","containers","fly","firecracker"]
title: "Container Platform Comparison: Cloudflare Containers vs Rivet Containers vs Fly Machines"
description: "**Rivet is an open-source, self-hostable serverless alternative to Cloudflare Workers, Durable Objects, and Containers. Check out Rivet Containers and visit our GitHub.**"
---
...
**Rivet is an open-source, self-hostable serverless alternative to Cloudflare Workers, Durable Objects, and Containers. Check out [Rivet Containers](/docs/actors) and [visit our GitHub](https://github.com/rivet-dev/engine).**

Cloudflare just launched [Cloudflare Containers](https://developers.cloudflare.com/containers/), a platform with many similarities to [Rivet Containers](/docs/actors) and [Fly Machines](https://fly.io/docs/machines).
...
<img src={imgCfArch.src} alt="Routing architecture for Cloudflare Containers" />
...
<img src={imgRivetArchDirect.src} alt="Rivet architecture showing request going directly to a container" />
...
<img src={imgRivetArchWorker.src} alt="Rivet architecture showing request going to Rivet Function then to a Rivet Worker" />
...
<img src={imgFlyArch.src} alt="Fly Machines architecture showing request going to a Fly Machine" />
...
Rivet allows you to run a [complete Rivet cluster locally in one command](https://rivet.dev/docs/cloud/self-hosting/single-container) or within your own Docker Compose. This enables you to:
